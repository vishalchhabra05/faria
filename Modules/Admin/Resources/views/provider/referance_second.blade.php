                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb m-0 p-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{url('/admin/provider/provider/edit',$id)}}">Edit Details</a></li>
                          @endif 
                        <li class="breadcrumb-item active" aria-current="page">@if(!empty($detail->full_name))Edit @else Add @endif Second Reference</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <div class="fade-in">
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
    <form method="post" id="validate-form" class="form-horizontal" action="{{url('admin/provider/step6',$id)}}" enctype="multipart/form-data">
    @csrf
        <div class="col-sm-12">
        ...
        <div class="card-footer">
            <button class="btn btn-sm btn-primary" type="submit">Save & Continue</button>
        </div>
    </form>
