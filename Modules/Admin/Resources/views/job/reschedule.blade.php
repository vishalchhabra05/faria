...
<div class="main-content">
    <div class="page-title col-sm-12">
        <div class="row align-items-center">
            <div class="col-md-6">
            <h1 class="h3 m-0">Reschedule Job Request</h1>
            </div>
            <div class="col-md-6">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb m-0 p-0">
                    <li class="breadcrumb-item"><a href="{{url('/admin')}}">Home</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Reschedule Job Request</li>
                    </ol>
                </nav>
                                ...
                                @php $i = 1; @endphp
                                  @foreach($data as $value)
                                        <tr>
                                            ...
                                            <td>
                                            @if($value->status == '1')
                                            <span class="badge badge-success float-right">Quote Revived</span>
