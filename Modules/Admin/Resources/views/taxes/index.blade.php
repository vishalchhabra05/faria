                                ...
                                @php $i = 1; @endphp
                                  @foreach($data as $value)
                                        <tr>
                                            ...
                                            <td>{{$value->texes ?? ''}}</td>                              
                                            <td class="action">    
                                           <a href="javascript:void(0);" data-toggle="tooltip" title="Delete" type="button" class="icon-btn delete" onclick="deleteRecord('{{url('admin/tax/delete', $value->id)}}')"><i class="fal fa-times"></i></a>
                                           <a data-toggle="tooltip" title="Update" type="button" class="icon-btn preview" href="{{url('admin/tax/edit', $value->id)}}"><i class="fal fa-edit"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
