...
<div class="main-content">
    <div class="page-title col-sm-12">
        <div class="row align-items-center">
            <div class="col-md-6">
                <h1 class="h3 m-0">Edit Customer</h1>
            </div>
            <div class="col-md-6">
    ...
    @csrf
        ...
        <div class="col-sm-12">
            <div class="form-group">
                ...
                <input class="form-control mobile required" minlength="5" maxlength="13" id="mobile" name="mobile" type="text" placeholder="Mobile Number" value="{{$value->mobile}}" >
        ...
        <div class="col-sm-12">
            ...
            <li><img src="{{$value->image}}" width="100px"/></li>
            </ul>
            </div>
