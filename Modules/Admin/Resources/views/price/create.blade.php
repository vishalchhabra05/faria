    ...
    <div class="fade-in">
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
    <form method="post" id="validate-form" class="form-horizontal" action="{{url('admin/price/store')}}" enctype="multipart/form-data">
    @csrf
    <div class="col-sm-12">
        ...
        <div class="col-sm-12">
            <div class="form-group">
                ...
                <input class="form-control required number" minlength="1" maxlength="10" id="price" name="price" type="text" placeholder="Service Price" value="{{old('price')}}" >
                    @if ($errors->has('price'))
        ...
        <div class="col-sm-12">
            <div class="form-group">
                ...
                <input class="form-control required number" minlength="1" maxlength="10" id="extra_price" name="extra_price" type="text" placeholder="Extra Price" value="{{old('extra_price')}}" >
        ...
        <div class="col-sm-12">
            <div class="form-group">
                ...
                <input class="form-control required"  id="city" name="city" type="text" placeholder="City" value="{{old('city')}}" >
                    @if ($errors->has('city'))
