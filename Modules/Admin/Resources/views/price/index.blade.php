...
<div class="main-content">
    <div class="page-title col-sm-12">
        <div class="row align-items-center">
           ...
           <a href="{{ url('admin/price/add') }}" class="btn btn-sm btn-primary" >Add Price</a>
           </div>
        </div>
    </div>
                                ...
                                @php $i = 1; @endphp
                                  @foreach($data as $value)
                                        <tr>
                                            ...
                                            <td>{{$value->city ?? ''}}</td>                                     
                                            <td class="action">    
                                           <a href="javascript:void(0);" data-toggle="tooltip" title="Delete" type="button" class="icon-btn delete" onclick="deleteRecord('{{url('admin/price/delete', $value->slug)}}')"><i class="fal fa-times"></i></a>
                                           <a data-toggle="tooltip" title="Update" type="button" class="icon-btn preview" href="{{url('admin/price/edit', $value->slug)}}"><i class="fal fa-edit"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
