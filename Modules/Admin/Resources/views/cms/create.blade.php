...
<div class="main-content">
    <div class="page-title col-sm-12">
        <div class="row align-items-center">
            <div class="col-md-6">
                <h1 class="h3 m-0">Create Page</h1>
            </div>
            <div class="col-md-6">
    ...
    <div class="fade-in">
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
    <form method="post" id="validate-form" class="form-horizontal" action="{{url('admin/cms/store')}}" enctype="multipart/form-data">
    @csrf
        <div class="col-sm-12">
        ...
        <div class="col-sm-12">
                <div class="form-group">
                    ...
                    <input class="form-control required"  id="meta_tile" name="meta_tile" type="text" placeholder="Meta Tile">
                </div>
        ...
        <div class="col-sm-12">
                <div class="form-group">
                    ...
                    <input class="form-control required"  id="meta_keywords" name="meta_keywords" type="text" placeholder="Meta Keywords">
                </div>
